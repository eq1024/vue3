  ...
  <div class="layout-top-bar" :class="[tabStyle]" :style="{ width: topBarWidth() }">
    <div class="menu">
      <div class="left" style="display: flex">
        <!-- 系统信息  -->
        <div v-if="isTopMenu" class="top-header" @click="toHome">
          <ArtLogo class="logo" />
          <p v-if="width >= 1400">
        ...
        <!-- 菜单按钮 -->
        <div v-if="isLeftMenu && shouldShowMenuButton" class="btn-box">
          <div class="btn menu-btn">
            <i class="iconfont-sys" @click="visibleMenu">&#xe6ba;</i>
          </div>
        </div>
        <!-- 刷新按钮 -->
        <div v-if="shouldShowRefreshButton" class="btn-box">
      ...
      <div class="right">
        <!-- 搜索 -->
        <div v-if="shouldShowGlobalSearch" class="search-wrap">
          <div class="search-input" @click="openSearchDialog">
            ...
            <div class="search-keydown">
              <i v-if="isWindows" class="iconfont-sys">&#xeeac;</i>
        ...
        <!-- 全屏按钮 -->
        <div v-if="shouldShowFullscreen" class="btn-box screen-box" @click="toggleFullScreen">
          <div
            class="btn"
        ...
        <!-- 通知 -->
        <div v-if="shouldShowNotification" class="btn-box notice-btn" @click="visibleNotice">
          <div class="btn notice-button">
            <i class="iconfont-sys notice-btn">&#xe6c2;</i>
            <span class="count notice-btn" />
          </div>
        </div>
        <!-- 聊天 -->
        <div v-if="shouldShowChat" class="btn-box chat-btn" @click="openChat">
        ...
        <!-- 语言 -->
        <div v-if="shouldShowLanguage" class="btn-box">
        ...
        <!-- 设置 -->
        <div v-if="shouldShowSettings" class="btn-box" @click="openSetting">
        ...
        <!-- 切换主题 -->
        <div v-if="shouldShowThemeToggle" class="btn-box" @click="themeAnimation">
...
<template>
  <div class="layout-top-bar" :class="[tabStyle]" :style="{ width: topBarWidth() }">
    <div class="menu">
      <div class="left" style="display: flex">
        <!-- 系统信息  -->
        <div class="top-header" v-if="isTopMenu" @click="toHome">
          <ArtLogo class="logo" />
          <p v-if="width >= 1400">
{{ AppConfig.systemInfo.name }}
</p>
