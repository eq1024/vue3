...
function handleImageCardClick(card: any) {
  console.log(card)
}
</script>
...
<template>
  <div class="cards">
    ...
    <ElRow :gutter="20">
      <ElCol v-for="card in statsCards" :key="card.id" :xs="24" :sm="12" :md="6">
        <ArtStatsCard
          :icon="card.icon"
          :title="card.title"
    ...
    <ElRow :gutter="20">
      <ElCol v-for="card in progressCards" :key="card.id" :xs="24" :sm="12" :md="6">
    ...
    <ElRow :gutter="20">
      <ElCol v-for="card in imageCards" :key="card.id" :xs="24" :sm="12" :md="6">
        <ArtImageCard
