      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-buttons">
            <el-button size="small" @click="clearFullEditor">
              清空
            </el-button>
            <el-button size="small" @click="getFullEditorContent">
              获取内容
            </el-button>
            <el-button size="small" @click="setFullEditorDemo">
              设置示例
            </el-button>
          </div>
        </div>
    ...
    <el-card class="editor-card" shadow="never">
      <template #header>
        <div class="card-header">
          <span>✨ 简化工具栏编辑器</span>
          <div class="header-buttons">
            <el-button size="small" @click="clearSimpleEditor">
              清空
            </el-button>
            <el-button size="small" @click="getSimpleEditorContent">
              获取内容
            </el-button>
            <el-button size="small" @click="setSimpleEditorDemo">
              设置示例
            </el-button>
          </div>
        </div>
