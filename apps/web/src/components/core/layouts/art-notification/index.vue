...
<template>
  ...
  >
    ...
    <div class="content">
      <div class="scroll">
        <!-- 通知 -->
        <ul v-show="barActiveIndex === 0" class="notice-list">
        ...
        <!-- 消息 -->
        <ul v-show="barActiveIndex === 1" class="user-list">
        ...
        <!-- 待办 -->
        <ul v-show="barActiveIndex === 2" class="base">
        ...
        <!-- 空状态 -->
        <div v-show="currentTabIsEmpty" class="empty-tips">
      ...
      <div class="btn-wrapper">
        <el-button v-ripple class="view-all" @click="handleViewAll">
          {{ $t('notice.viewAll') }}
        </el-button>
      </div>
    </div>
